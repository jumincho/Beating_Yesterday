...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View.OnClickListener listener1 = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((sf.getInt("Kcal", 0) < sf1.getInt("Kcal", 0))
                        && sf2.getLong("interval", 0) < sf3.getLong("interval", 0)) {
    ...
    public void updateData(View root) {
        ...
        SharedPreferences.Editor e = sf.edit();
        e.putString("Name", HomeViewModel.name);
        e.putString("Gender", HomeViewModel.gender);
